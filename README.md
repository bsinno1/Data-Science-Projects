...
## Sprint #2: [Data Preprocessing](https://github.com/bsinno1/Data-Science-Projects/tree/main/01_data_processing)

### The task: 
Prepare a report for a bank\'s loan division. You\'ll need to find out if customers\' marital status and number of children has an impact on whether they will default on a loan. The bank already has some data on customers\' credit worthiness. Your report will be considered when building a credit scoring of a potential customer. A credit scoring is used to evaluate the ability of a potential borrower to repay their loan.

## Sprint #3: [Exploratory Data Analysis (EDA)](https://github.com/bsinno1/Data-Science-Projects/tree/main/02_EDA)
...
## Sprint #4: [Statistical Data Analysis](https://github.com/bsinno1/Data-Science-Projects/tree/main/03_statistical_data_analysis)
...
### The task: 
Carry out a preliminary analysis of the plans based on a relatively small client selection. You'll have the data on 500 "Megaline" clients, specifically, who the clients are, where they are from, which plan they use, the number of calls made and SMS they sent in 2018. You have to analyze clients' behavior and work out the most profitable prepaid plan.

# [Integrated Project 1](https://github.com/bsinno1/Data-Science-Projects/tree/main/04_integrated_project_1)
...
## Sprint #6: [Data Collection and Storage (SQL)](https://github.com/bsinno1/Data-Science-Projects/tree/main/05_data_collection_sql)
...
## Sprint #7: [Introduction to Machine Learning](https://github.com/bsinno1/Data-Science-Projects/tree/main/06_intro_ml)
...
## Sprint #8: [Supervised Learning](https://github.com/bsinno1/Data-Science-Projects/tree/main/07_supervised_learning)
...
## Sprint #9: [Machine Learning for Business](https://github.com/bsinno1/Data-Science-Projects/tree/main/08_ml_for_business)
...
# [Integrated project 2](https://github.com/bsinno1/Data-Science-Projects/tree/main/09_integrated_project_2)

Prepare a prototype of a machine learning model for Zyfra. The company develops efficiency solutions for heavy industry. 

### The task: 
Prepare a model to predict the amount of gold recovered from gold ore. You have the data on extraction and purification. The model will help to optimize the production and eliminate unprofitable parameters. You need to:

- Prepare the data;
- Perform data analysis;
- Develop and train a model;

## Sprint #10: [Linear Algebra](https://github.com/bsinno1/Data-Science-Projects/tree/main/10_linear_algebra)
...
## Sprint #11: [Numerical Methods](https://github.com/bsinno1/Data-Science-Projects/tree/main/11_numerical_methods)
...
## Sprint #12: [Time Series](https://github.com/bsinno1/Data-Science-Projects/tree/main/12_time_series)
...
## Sprint #13: [Machine Learning for Texts](https://github.com/bsinno1/Data-Science-Projects/tree/main/13_ml_for_text)
...
## Sprint #14: [Computer Vision](https://github.com/bsinno1/Data-Science-Projects/tree/main/14_computer_vision)
...
## Sprint 15#: Unsupervised Learning: No project

# [Integrated project 3](https://github.com/bsinno1/Data-Science-Projects/tree/main/15_integrated_project_3)
